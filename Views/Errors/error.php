...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=media();?>error/css/styles.css">
</head>
<body>
    <main>
        <div class="container">
      ...
      C360.647,451.083,349.251,457.661,338.164,454.689z" />
        ...
        s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
          ...
          278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928         " />
                ...
                <img src="<?=media();?>error/image/logo.png" alt="" class="topleft">
                <div class="col-md-6 align-self-center">
                    <h2>¡Error 404!</h2>
                    <h3>Oops...</h3>
                    <p>
                        La página a la que intentas acceder no esta disponible por el momento o no existe.
                    </p>
                    <a class="btn btn-info" href="<?=BASE_URL?>" role="button">Volver al inicio</a>
                </div>
            </div>
        </div>
    </main>
    ...
    <script type="text/javascript" src="<?=media();?>error/js/functions.js"></script>
</body>
</html>